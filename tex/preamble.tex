...
\newtcolorbox[auto counter,number within=chapter,number format=\arabic]{corollary}[1][]{
...
\newtcolorbox[auto counter,number format=\arabic]{notice}[1][]{
            colback=mahsky!10!white,enhanced,
            title={\textbf{\faExclamation \ \ Chú ý --- \ }},
            boxrule=0pt,
	    frame hidden,
            breakable,fonttitle=\sffamily,
            arc=0mm,
...
\newtcolorbox[auto counter,number format=\arabic]{motivation}[1][]{
            colback=mahlightblue!10!white,enhanced,
            title={\textbf{\faQuestion \ \ Ý tưởng}},
            boxrule=0pt,
	    frame hidden,
            breakable,fonttitle=\sffamily,
            arc=0mm,
...
\fancyhead[RE]{\footnotesize \textsc{Tuyển tập chuyên đề toán THPT}, by Mark Nguyen}
